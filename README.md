...
## Key Findings
• 62.75% of CSAT scores were missing/unrecorded (defaulted to 0), a systemic logging issue most severe in the Call-Center channel   
​• 51.87% of interactions carry Negative or Very Negative sentiment, indicating widespread customer friction 
​• SLA adherence does not heavily correlate with satisfaction, showing a flat performance spread across categories (Above SLA: 5.62 avg vs Below SLA: 5.56 avg)  
​• Email is the lowest-scoring communication channel (5.48 avg), while the Call-Center achieves the highest satisfaction (5.61 avg)  
​• Service Outage interactions drive the lowest satisfaction levels (5.52 avg), while Payments represent the highest resolution satisfaction (5.63 avg)
